...
// void stateServiceUpdateWiFiStatus(
...
// void stateServiceSetWiFiCredentials(const String &ssid, bool
// hasCredentials)
// {
//     gState.wifi.ssid = ssid;
// }
...
//     serializeNetworkState(root["network"].to<JsonObject>(),
//     gState.network); return serializeDoc(doc);
// }
